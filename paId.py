...
__author__ = 'HAROON PATHAAN'
__copyright = 'All rights reserved . Copyright  HAROON'
...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;92m         Haroon Pathan                       \n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : HAROON ?????\n\x1b[1;97m\xe2\x9e\xa3 Github : https://github.com/Haroon302\n\x1b[1;97m\xe2\x9e\xa3 WP NO: +923494462675\n\x1b[1;91m-----------------------------------------------'
...
def reg():
    ...
    r = requests.get('https://pastebin.com/raw/51V5zu8Y').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+959687355980')
        reg()
